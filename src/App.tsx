...
/* ─── Gallery images ────────────────────────────────────────────────────── */
const galleryImages = [
  '/IMG20260419131110.jpg',
  '/IMG20260419131905.jpg',
  '/IMG20260419153321.jpg',
  '/IMG20260419153558.jpg',
  '/IMG20260419163826.jpg',
]
...
const ContentBlock = ({
  ...
  return (
    ...
    >
      {/* Watermark number — scales in from large */}
      <motion.span
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:h-150">
        ...
        {/* ── IMAGE COLUMN — curtain reveal + descale + hover zoom ─────── */}
        <motion.div
...
const App: React.FC = () => {
  ...
  return (
    <div className="bg-bg text-white overflow-x-hidden">
      ...
      {/* ═══════════════════════════════ HERO ════════════════════════════ */}
      <section ref={heroRef} className="relative h-150 md:h-187.5 lg:h-250 overflow-hidden">

        {/* Parallax + ken-burns background */}
        <motion.img
          src="/IMG20260419134932.jpg"
          alt=""
          ...
          <div className="max-w-7xl mx-auto w-full px-6 md:px-8 lg:px-10">
            <div className="lg:ml-[22%]">
              ...
              <motion.a
                ...
                whileHover={{ x: 8 }}
              >
                <span className="font-barlow font-bold text-lg group-hover:text-accent transition-colors">
                  scroll down
                </span>
                <motion.span
                  animate={{ y: [0, 7, 0] }}
        ...
        {/* ── Slider indicator ── */}
        {/* <motion.div
          className="hidden xl:flex absolute right-6 items-start z-20"
          style={{ top: '33%' }}
          initial={{ opacity: 0, x: 30 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ delay: 1.9, type: 'spring', stiffness: 80, damping: 20 }}
        >
          <div className="flex flex-col items-end gap-10 mr-6 font-barlow font-bold text-lg">
            {['Start', '01', '02', '03'].map(t => <span key={t}>{t}</span>)}
          </div>
          <div className="relative w-0.75 h-60">
      ...
      {/* ═══════════════════════════ CONTENT ═════════════════════════════ */}
      <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-10 flex flex-col items-center gap-16 md:gap-24 lg:gap-45 pt-12 pb-20">

        <ContentBlock
          id="trails"
          number="01"
          tagline="Where It Begins"
          title="Step Into the Forest"
          imageSrc="/IMG20260419130432.jpg"
          body={
            <p>
              Before the steep climbs and rocky crossings, there is this — a sun-washed
              green clearing where the trail first announces itself. Tall trees frame the
              far edge like a gateway, their roots deep in soil that has guided hikers for
              generations. This is the moment to tighten your laces, calibrate your pace,
              and let the forest set its own quiet tempo. Every great trail starts with a
              single, deliberate first step.
            </p>
          }
        />
        ...
        <ContentBlock
          number="02"
          tagline="Navigate the Wild"
          title="Cross the Wild Stream"
          imageSrc="/IMG20260419132429.jpg"
          imageLeft
          body={
            <>
              <p className="mb-4">
                At every bend in the trail, another crossing waits. Smooth, water-worn
                sandstone stretches across the stream bed — polished into shallow channels
                by years of seasonal flow, beautiful to photograph and demanding to navigate.
              </p>
              <p>
                Reading the rock is an art: find where the water runs shallowest, test
                each foothold before committing, and use your poles for balance. Each
                crossing builds your confidence and your connection to the trail itself.
              </p>
            </>
          }
        />
        ...
        <ContentBlock
          number="03"
          tagline="Hidden Wonders"
          title="Chase the Hidden Cascade"
          imageSrc="/IMG20260419132834.jpg"
          body={
            <p>
              You hear it before you see it — a thin ribbon of water sliding down a
              staircase of moss-edged rock, caught between walls of dense jungle. This
              natural cascade is the trail's reward for those who push past the easy
              stretches. The cool mist drifting off the falls is instant relief on a long,
              humid hike. Sit here, eat your snacks, and let the sound of running water
              reset your energy.
            </p>
          }
        />
        ...
        <ContentBlock
          ...
          title="Face the Canyon Wall"
          imageSrc="/IMG20260419134101.jpg"
          imageLeft
          imageObjectPosition="top"
          body={
            <p>
              Suddenly the forest parts and there it stands — a sheer wall of ancient
              rock, streaked with mineral veins and softened at the crown by a thick fringe
              of jungle green. No trail cuts through the stone; you skirt its base or find
              the flanking ridgeline path. Either way, you leave with new respect for how
              the earth shapes itself over millennia.
            </p>
          }
        />
        ...
        <ContentBlock
          ...
          imageSrc="/IMG20260419144336.jpg"
          body={
            <p>
              Midway through the hike the jungle opens to a wide, still river fringed by
              clean sandy banks and ringed by forested hills that roll away into the hazy
              distance. The water is slow and clear; the air genuinely cool in the shade
              of the overhanging trees. Fill your water, eat your lunch, let your boots dry
              in the sun. The river does not hurry, and neither should you.
            </p>
          }
        />
        ...
        <ContentBlock
          number="06"
          tagline="Trail Companions"
          title="Walk with the Jungle"
          imageSrc="/IMG20260419163602.jpg"
          imageLeft
          body={
            <>
              <p className="mb-4">
                Hiking is better with someone beside you — someone to steady your nerves
                at a tricky crossing, share a laugh when the mud claims a boot, or simply
                walk quietly beside you when the forest asks for silence.
              </p>
              <p>
                Two figures moving toward the last light of day, stream beside them and
                canopy above, capture everything the trail is meant to give.
              </p>
            </>
          }
        />
        ...
        <ContentBlock
          ...
          title="Follow the Light Home"
          imageSrc="/IMG20260419165503.jpg"
          body={
            <p>
              When the sun drops below the ridge and angles its last rays through the
              canopy, the jungle transforms. Every leaf glows amber, every root and stone
              casts a long warm shadow, and the path you have walked all day suddenly looks
              like a painting. Move with intention, watch your footing, and carry that
              light all the way back to the trailhead with you.
            </p>
          }
        />
